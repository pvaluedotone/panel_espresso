"""
Panel Data Analysis App with pyfixest - EXPERIMENTAL VERSION
...
- NEW: Two-way clustering with WCR31 (preserves correlation structure)
"""
...
"""
        ...
        if use_wild_bootstrap:
            if bootstrap_variables and len(bootstrap_variables) > 0:
                ...
                # Single variable bootstrap (original behavior)
    ...
    **Note**: Standard errors clustering and bootstrap p-values for robust inference.
    ...
    with gr.Row():
        ...
        with gr.Column(scale=1):
            ...
            # Wild Cluster Bootstrap UI Section
